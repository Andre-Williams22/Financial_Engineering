...
small_symbols = {'PLTR', 'MMM', 'ABT', 'ABBV', 'ACN', 'ATVI', 'ADBE', 'AMD', 'AAP', 'AES',
...
full_df.to_csv('sp500.csv', index=False, sep=',')
# full_df.convert_into("full_df", "sp500.csv", outpu_format="csv")
